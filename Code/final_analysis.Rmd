...
## Executive Summary
A random forest model is used to predict whether a subject is executing a weight lifting exercise correctly. If not, the specific error is predicted. The predicted out of sample accuracy for the best model is 99%.
